    ...
    <div class="max-w-6xl mx-auto px-4 sm:px-6">
      <div class="py-12 md:py-20">
        ...
        <div class="max-w-3xl mx-auto text-center pb-12 md:pb-20">
          <h2 class="h2 mb-4 text-blue-900">Why work with us?</h2>
          <p class="text-xl text-blue-800">We offer many benefits compared to typical custom software development firms.
          </p>
        </div>
        ...
        <div
          ...
          <div class="relative flex flex-col items-center" data-aos="fade-up" data-aos-anchor="[data-aos-id-blocks]">
            <svg class="w-16 h-16 mb-4" xmlns="http://www.w3.org/2000/svg" viewBox="0 0 320 512">
              <!--! Font Awesome Pro 6.2.1 by @fontawesome - https://fontawesome.com License - https://fontawesome.com/license (Commercial License) Copyright 2022 Fonticons, Inc. -->
              <path class="fill-current text-purple-600"
            ...
            <h4 class="h4 mb-2 text-blue-900">Affordable</h4>
            <p class="text-lg text-blue-800 text-center">Typical software development companies in North America charge
              over $150/hour. We charge a small fraction of that, while maintaining excellent quality.</p>
          </div>

          <!-- 2nd item -->
          <div class="relative flex flex-col items-center" data-aos="fade-up" data-aos-delay="100"
            data-aos-anchor="[data-aos-id-blocks]">
            <svg xmlns="http://www.w3.org/2000/svg" viewBox="0 0 512 512" class="w-16 h-16 mb-4">
              <!--! Font Awesome Pro 6.2.1 by @fontawesome - https://fontawesome.com License - https://fontawesome.com/license (Commercial License) Copyright 2022 Fonticons, Inc. -->
              <path class="fill-current text-purple-600"
          ...
          <div class="relative flex flex-col items-center" data-aos="fade-up" data-aos-delay="300"
            ...
            <h4 class="h4 mb-2 text-blue-900">Clear Milestones</h4>
            <p class="text-lg text-blue-800 text-center">We work together with you to define milestones for your
              project. After each milestone, you will receive a fully-functioning app that you can launch
              on the market.</p>
          </div>
          ...
          <div class="relative flex flex-col items-center" data-aos="fade-up" data-aos-delay="400"
            data-aos-anchor="[data-aos-id-blocks]">
            <svg class="w-16 h-16 mb-4" xmlns="http://www.w3.org/2000/svg" viewBox="0 0 512 512">
              <!--! Font Awesome Pro 6.2.1 by @fontawesome - https://fontawesome.com License - https://fontawesome.com/license (Commercial License) Copyright 2022 Fonticons, Inc. -->
              <path class="fill-current text-purple-600"
                d="M0 224c0 17.7 14.3 32 32 32s32-14.3 32-32c0-53 43-96 96-96H320v32c0 12.9 7.8 24.6 19.8 29.6s25.7 2.2 34.9-6.9l64-64c12.5-12.5 12.5-32.8 0-45.3l-64-64c-9.2-9.2-22.9-11.9-34.9-6.9S320 19.1 320 32V64H160C71.6 64 0 135.6 0 224zm512 64c0-17.7-14.3-32-32-32s-32 14.3-32 32c0 53-43 96-96 96H192V352c0-12.9-7.8-24.6-19.8-29.6s-25.7-2.2-34.9 6.9l-64 64c-12.5 12.5-12.5 32.8 0 45.3l64 64c9.2 9.2 22.9 11.9 34.9 6.9s19.8-16.6 19.8-29.6V448H352c88.4 0 160-71.6 160-160z" />
            </svg>
            <h4 class="h4 mb-2 text-blue-900">Frequent Feedback</h4>
            <p class="text-lg text-blue-800 text-center">We build your app, together. Bi-weekly client meetings are set
              up to make sure your app looks and works just the way you want.</p>
          </div>
          ...
          <div class="relative flex flex-col items-center" data-aos="fade-up" data-aos-delay="500"
            ...
            <h4 class="h4 mb-2 text-blue-900">Quick Delivery</h4>
            <p class="text-lg text-blue-800 text-center">We're a team of two self-directed developers. There's no
              management overhead, meaning that we can deliver quickly and interact directly with you to make important
              decisions.</p>
          </div>
